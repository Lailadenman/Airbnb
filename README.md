...
![airbnb schema](https://github.com/[Lailadenman]/[Airbnb]/photos/blob/[main]/Airbnb_schema_mswv5h.png?raw=true)
...
* Request
  * Method: GET
  * URL: /api/spots
  <!-- ?page=[ :intM ]&size=[ :intM ]&minLat=[ :decO ]&maxLat=[ :decO ]&minLng=[ :decO ]&maxLng=[ :decO ]&minPrice=[ :decO ]&maxPrice=[ :decO ] -->
